package com.eugeniobarquin.madridshops.fragments;
...
import com.eugeniobarquin.madridshops.adapters.ShopsAdapter;
...
public class ShopsFragment extends Fragment {
    ...
    public void setShops(Shops shops) {
        ...
        adapter.setOnClickListener(new OnElementClick<Shop>() {
            @Override
            public void clikedOn(@NonNull Shop shop, int position) {
                Log.d("Click", shop.getName());
                if (listener != null) {
                    ShopsFragment.this.listener.clikedOn(shop, position);
                }
            }
        });
    }
